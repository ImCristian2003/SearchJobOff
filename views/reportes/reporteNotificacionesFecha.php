<?php
    ...
    $campos = new NotificacionController();
    $campo = $campos->reporteNotificacionesFecha();
    ...
    <body>
        ...
        <div class="container-postulados">
            <div class="details">
            <h2>Notificaciones con fechas entre '.$_POST['fecha_inicial']." y ".$_POST['fecha_final'].'</h2>
                <table border="1">
                    <tr>
                        <th>Codigo</th>
                    ...
                    while($campos = $campo->fetch_object()){
                        $html .= '<tr>';
                            ...
                            $html .= "<td>".$campos->asunto."</td>";
                            $html .= "<td>".$campos->cuerpo."</td>";
    ...
    $dompdf->render();
    $dompdf->stream("notificaciones_fecha.pdf", array('Attachment'=>'0'));
