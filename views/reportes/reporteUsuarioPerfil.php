<?php
    ...
    $campos = new UsuarioDosController();
    $campo = $campos->reporteUsuariosPerfil();
    if(isset($_POST['perfil']) && $_POST['perfil'] == '1'){
        $perfil = "Empleado";
    }else if(isset($_POST['perfil']) && $_POST['perfil'] == '2'){
        $perfil = "Empresa";
    }else{
    ...
    <body>
        ...
        <div class="container-postulados">
            <div class="details">
                <h2>Usuarios con perfil "'.$perfil.'"</h2>
                <table border="1">
                    <tr>
                    ...
                    while($campos = $campo->fetch_object()){
                        $html .= '<tr>';
                            ...
                            $html .= "<td>".$campos->perfil." - ".$campos->nombre_perfil."</td>";
                            if($campos->estado == "1"){
                                $estado_usuario = "Activo";
                            }else{
                                $estado_usuario = "Inactivo";
                            }
                            $html .= "<td>".$estado_usuario."</td>";
                        $html .= '<tr>';
                    };
                $html .= '</table>
            </div>
    ...
    $dompdf->render();
    $dompdf->stream("postulaciones_estado.pdf", array('Attachment'=>'0'));
