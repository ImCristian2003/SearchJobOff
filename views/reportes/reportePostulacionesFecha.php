<?php
    ...
    $campos = new PostulacionDosController();
    $campo = $campos->reportePostulacionesFecha();
    ...
    <body>
        ...
        <div class="container-postulados">
            <div class="details">
            <h2>Postulaciones con fechas entre '.$_POST['fecha_inicial']." y ".$_POST['fecha_final'].'</h2>
                <table border="1">
                    <tr>
                        <th>Codigo</th>
                    ...
                    while($campos = $campo->fetch_object()){
                        $html .= '<tr>';
                            ...
                            $html .= "<td>".$campos->nombre_empleo." - ".$campos->codigo_empleo."</td>";
    ...
    $dompdf->render();
    $dompdf->stream("postulaciones_fecha.pdf", array('Attachment'=>'0'));
