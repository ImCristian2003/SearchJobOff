<?php
    ...
    $campo = $campos->reporteNotificacionesEstado();
    ...
    <body>
        ...
        <div class="container-postulados">
            <div class="details">
                <h2>Notificaciones con estado "'.$_POST['notificacion'].'s"</h2>
                <table border="1">
                    <tr>
                        <th>Codigo</th>
    ...
    $dompdf->render();
    $dompdf->stream("notificaciones_estado.pdf", array('Attachment'=>'0'));
