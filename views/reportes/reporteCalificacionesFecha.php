<?php
    ...
    //Instancia para sacar todos los Tipos de Contrato
    $campos = new CalificacionController();
    $campo = $campos->reporteCalificacionesFecha();
    ...
    <body>
        ...
        <div class="container-postulados">
            <div class="details">
                <h2>Calificaciones con fechas entre '.$_POST['fecha_inicial']." y ".$_POST['fecha_final'].'</h2>
                <table border="1">
                    <tr>
                        <th>Codigo</th>
                    ...
                    while($campos = $campo->fetch_object()){
                        $html .= '<tr>';
                            $html .= "<td>".$campos->codigo."</td>";
                            $html .= "<td>".$campos->nombre." - ".$campos->id."</td>";
                            $html .= "<td>".$campos->calificacion."</td>";
                            $html .= "<td>".$campos->descripcion."</td>";
    ...
    $dompdf->render();
    $dompdf->stream("calificaciones_fecha.pdf", array('Attachment'=>'0'));
