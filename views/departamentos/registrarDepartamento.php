<?php 
    ...
    if(!isset($_SESSION['admin'])){
        ...
        //Instancia para mostrar los departamentos
        $dept = new DepartamentoController();
        $departamento = $dept->mostrarDepartamento();
...
<body>
    ...
    <div class="container-municipio">
        <a href="indexMunicipio.php" class="icono-volver"><span class="icon-undo2"></span></a>
        <div class="details">

            <h2>Registra un Municipio</h2>
            <?php   if(isset($_SESSION['complete']) && $_SESSION['complete'] == 'Complete'): ?>
                        
                        <strong>Municipio añadido exitosamente</strong>
                
            <?php   elseif(isset($_SESSION['fail']) && $_SESSION['fail'] == 'Fail'):  ?>

                        <strong>Error al querer añadir el municipio</strong>

            <?php   endif; ?>
            <p>
                Bienvenido <b> <?=$_SESSION['admin']->nombre?></b>, en esta sesión puedes
                registrar un municipio y/o vereda que va estar disponible en nuestro sitio web.
            </p>
            <form action="../../execute.php?controller=municipioExecute&action=guardarMunicipio" method="post">
                ...
                <select name="departamento" id="">
                    <!---Ciclo para imprimir los departamento en el select-->
                    <?php while($dept = $departamento->fetch_object()): ?>
