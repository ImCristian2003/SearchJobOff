<?php
    ...
    //Instancia para sacar todos los Sectores
    $campos = new EmpleoController();
    $campo = $campos->empleosPublicados();
                ...
                <table border="0">
                    ...
                    while($campos = $campo->fetch_object()){
                        $html .= '<tr>';
                            ...
                            $html .= "<td>".$campos->nombre_municipio."</td>";
                            $html .= "<td>".$campos->direccion."</td>";
                            $html .= "<td>".$campos->vacantes."</td>";
                            $html .= "<td>".$campos->funcion."</td>";
                            $html .= "<td>".$campos->salario."</td>";
                            $html .= "<td>".$campos->nombre_tipocontrato."</td>";
                        $html .= '<tr>';
                    };
                $html .= '</table>
            </div>
    ...
    $dompdf->render();
    $dompdf->stream("empleos.pdf", array('Attachment'=>'0'));
