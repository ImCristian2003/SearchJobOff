...
<body>
    ...
    <div class="container-datos">
        <div class="details">
            ...
            <?php   endif; ?>
            <form action="../../execute.php?controller=adminExecute&action=guardarAdmin&modificar=1" method="post" enctype="multipart/form-data">

                <label for="id">Identificación</label>
                <input type="text" name="id" value="<?=$_SESSION['admin']->id?>" id="id">
                ...
                <input type="text" name="nombre" value="<?=$_SESSION['admin']->nombre?>">
                <!-----Condición para validar que exista el error del campo nombre-------->
                <?php echo isset($_SESSION['errores']) ? mostrarError($_SESSION['errores'],'nombre') : ""; ?>

                <label for="apellido">Apellido</label>
                <input type="text" name="apellido" value="<?=$_SESSION['admin']->apellido?>">
                <!-----Condición para validar que exista el error del campo apellido-------->
                <?php echo isset($_SESSION['errores']) ? mostrarError($_SESSION['errores'],'apellido') : ""; ?>

                <label for="telefono">Teléfono</label>
                <input type="text" name="telefono" value="<?=$_SESSION['admin']->telefono?>">
                ...
                <input type="text" name="direccion" value="<?=$_SESSION['admin']->direccion?>">
                ...
                <input type="text" name="correo" value="<?=$_SESSION['admin']->correo?>">
                ...
                <?php if(!is_null($_SESSION['admin']->imagen)): ?>
                    <img src="../../uploads/usuarios_perfil/<?=$_SESSION['admin']->imagen?>" alt="perfil_usuario">
                <?php else: ?>
            ...
            <form action="cambiarContrasena.php" method="post">
                <input type="hidden" value="<?=$_SESSION['admin']->id?>">
