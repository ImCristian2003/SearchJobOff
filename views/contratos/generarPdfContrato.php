<?php
    ...
    $campos = new TipoContratoController();
    $campo = $campos->conseguirContratos();
    ...
    <body>
        ...
        <div class="container-postulados">
            <div class="details">
                <h2>Tipos de Contrato Registrados</h2>
                <table border="1">
                    <tr>
                        <th>Codigo</th>
                        <th>Nombre</th>
    ...
    $dompdf->render();
    $dompdf->stream("tipos_contrato.pdf", array('Attachment'=>'0'));
