...
<body>
    ...
    <div class="container-municipio">
        <a href="indexContrato.php" class="icono-volver"><span class="icon-undo2"></span></a>
        <div class="details">

            <h2>Registrar un Tipo de Contrato</h2>
            <!--En caso de haber una sesión de fallo o exito, mostrar un mensaje--->
            <?php   if(isset($_SESSION['complete']) && $_SESSION['complete'] == 'Complete'): ?>
                        
                        <strong>Tipo de Contrato añadido exitosamente</strong>
                
            <?php   elseif(isset($_SESSION['fail']) && $_SESSION['fail'] == 'Fail'):  ?>

                        <strong>Error al querer añadir el Contrato</strong>

            <?php   endif; ?>
            <p>
                Bienvenido <b> <?=$_SESSION['admin']->nombre?></b>, en esta sesión puedes
                registrar un contrato que va estar disponible en nuestro sitio web.
            </p>
            <form action="../../execute.php?controller=tipoContratoExecute&action=guardarContrato" method="post">
