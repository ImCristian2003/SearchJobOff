...
<body>
    ...
    <div class="container-municipio">
        <a href="indexSector.php" class="icono-volver"><span class="icon-undo2"></span></a>
        <div class="details">

            <h2>Registrar un Sector</h2>
            <!--En caso de haber una sesión de fallo o exito, mostrar un mensaje--->
            <?php   if(isset($_SESSION['complete']) && $_SESSION['complete'] == 'Complete'): ?>
                        
                        <strong>Sector añadido exitosamente</strong>
                
            <?php   elseif(isset($_SESSION['fail']) && $_SESSION['fail'] == 'Fail'):  ?>

                        <strong>Error al querer añadir el sector</strong>

            <?php   endif; ?>
            <p>
                Bienvenido <b> <?=$_SESSION['admin']->nombre?></b>, en esta sesión puedes
                registrar un sector que va estar disponible en nuestro sitio web.
            </p>
            <form action="../../execute.php?controller=sectorExecute&action=guardarSector" method="post">
